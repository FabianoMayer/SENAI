...
{
inteiro a,b,c,d,x // Declaração de variáveis
...
escreva ("Digite o quarto número \n") // Exibe uma mensagem pedindo ao usuário para digitar o quarto número
leia (d) // Armazena o valor inserido pelo usuário na variável (d)

x = a + b + c + d // Realiza a soma do valor das variáveis
